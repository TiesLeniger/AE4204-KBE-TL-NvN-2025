...
class LiftingSection:
    ...
    tip_chord: float = Input(0.2, validator = Range(0.0, root_chord))       # Tip chord of the section [m]              
...
class LiftingSurface(LoftedSolid):
    ...
    sections: list[LiftingSection] = Input([                            # List of sections, can be edited on runtime
        LiftingSection(
            idx = 0,
            root_af = "nlf1-0015.dat",
            tip_af = "nlf1-0015.dat",
            root_chord = 0.5,
            tip_chord = 0.2,
            span = 7.3,
            twist = 0.0,
    ...
    def profiles(self):
        ...
        for i in range(self.num_sections):
            ...
            next_pos = rotate(next_pos, "y", self.twist, deg = True)
